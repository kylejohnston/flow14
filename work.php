...
<head>
	...
	<meta name="description" content="Work from flow14, a graphic design studio that specializes in helping small businesses, nonprofits, and political groups with logo design, website design and more." />
	...
	<article class="content">
		<section class="block">
			<div class="pattern__2-8-2">
				<div class="inner">
                    <h1 id="fittext" class="center">Our Design Works</h1>
                    <p class="text__center">Things we&rsquo;ve made.</p>
				</div>
			</div>
		</section>
