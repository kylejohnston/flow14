...
<header>
	...
	<article class="content">
		...
		<section class="block item">
			<div class="col-6 order-2"><img src="img/samples/lisa-for-kansas/logo.png" width="100%"></div>
		...
		<section class="block item">
			<div class="pattern__3-6-3"><h2>Website</h2></div>
		</section>
		<section class="block item">
			<div class="col-6">
				<div class="inner">
		...
		<section class="block text__center">
			<div class="col-12">
				<div class="inner"><?php include('includes/cta_campaign.php'); ?></div>
			</div>
		</section>
	</article>
