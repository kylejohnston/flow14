...
<body class="neutral">
	...
	<article class="content">
		<section class="block">
			<div class="pattern__2-8-2 inner">
		...
		<section class="block">
			...
			<div class="col-6">
				...
				<img src="img/samples/rounding-up-undies/research.jpg" width="100%">
			</div>
			<div class="col-1 shim"></div>
			<div class="col-3">
				<div class="overlay overlay-dark">Sketches</div>
				<img src="img/samples/rounding-up-undies/sketches.jpg" width="100%">
			</div>
		</section>
