	...
	<article class="content">
		<section class="block">
			<div class="pattern__3-6-3">
				<div class="inner">
					...
					<p class="center">A selection of logos designed for startups, small businesses, and nonprofits.</p>
				</div>
			</div>
		</section>
		...
		<section class="block item">
			...
			<div class="col-4">
				...
				<div class="inner center">
					<p class="center"><a class="ghost-button" href="creative-outfitters">Read the case study</a></p>
				</div>
			</div>
			<div class="col-4">
				...
				<div class="inner center">
					<p class="center"><a class="ghost-button" href="hnc-living-logo-redesign">Read the case study</a></p>
				</div>
			</div>
			<div class="col-4">
		...
		<section class="block item">
			<div class="col-4">
				...
				<div class="inner center">
					<p class="center"><a class="ghost-button" href="rounding-up-undies">Read the case study</a></p>
				</div>
			</div>
			<div class="col-4">
				<a href="kansas-dems"><img src="img/samples/logos/1440x810/kansas-dems-2x.png" width="100%" height="auto" alt="Kansas Dems logo"></a>
				<div class="inner center">
					<p class="center"><a class="ghost-button" href="kansas-dems">Read the case study</a></p>
				</div>
			</div>
			<div class="col-4">
