...
<body class="neutral">
	...
	<article class="content">
		...
		<section class="block item">
			...
			<div class="col-5 order-2 background-white"><img src="img/samples/kansas-dems/kdp-logo.png" width="100%"></div>
			<div class="col-4 align__center order-1">
				<div class="inner">
					<h2>Logo Design</h2>
		...
		<section class="block">
			<div class="col-12 text__center">
				<div class="inner"><?php include('includes/cta_pol.php'); ?></div>
			</div>
		</section>
	</article>
