...
<head>
	...
	<title>Get Konnected Website Design | flow14. A Design Studio.</title>
	<meta name="description" content="Website design for Get Konnected, Boston's largest networking organizaiton focused on diversity and inclusion." />
	<meta name="geo.placename" content="Kansas City" />
	<link href="https://plus.google.com/103758963959064535451" rel="publisher" />
	<link href="http://www.flow14.com/work/get-konnected/" rel="canonical" />
...
<body>
	<div class="grid">
      ...
      <div>
		...
		<div class="grid-intro px-2 mt-2">
			<h1 class="larger">Get Konnected</h1>
      <h2 class="text-md color-medium light">Driving Diversity for Businesses in Boston</h2>
      <p class="text-sm color-medium">Services: UX &amp; Visual Design, Frontend Development, Branding</p>
    </div>
    ...
    <section class="main grid-in mt-3 mb-4">
      ...
      <div class="half-right grid-content">
        <p>Combining the design and frontend development expertise of flow14 and an innovative technology platform developed by Qwally, we launched the GK Market in partnership with Get Konnected, Boston’s largest networking organization focused on diversity and inclusion.</p>
        <p>The easy-to-use, mobile-optimized website helps Get Konnected showcase minority businesses, allows small businesses to create a digital profile, and makes it easier for Massachusetts residents to find opportunities to buy local.</p>
        <p>This case study highlights the process and milestones that led to the successful launch of the platform.</p>
      </div>
    </section>
    ...
    <section class="main grid-in grid-gap">
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-00.md.webp" media="(min-width: 50em)" type="image/webp">
      ...
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-01.md.webp" media="(min-width: 50em)" type="image/webp">
      ...
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-02.md.webp" media="(min-width: 50em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap mb-2">
      <picture class="img half-left mb-2 hidden">
        <source srcset="/img/samples/get-konnected/gk-process-03.md.webp" media="(min-width: 63em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap">
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-06.md.webp" media="(min-width: 50em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap mb-2">
      <picture class="img half-left mb-2 hidden">
        <source srcset="/img/samples/get-konnected/gk-process-07.md.webp" media="(min-width: 63em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap">
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-09.md.webp" media="(min-width: 50em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap mb-2">
      <picture class="img half-left mb-2 hidden">
        <source srcset="/img/samples/get-konnected/gk-process-010.md.webp" media="(min-width: 63em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap">
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-012.md.webp" media="(min-width: 50em)" type="image/webp">
      ...
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-013.md.webp" media="(min-width: 50em)" type="image/webp">
      ...
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-014.md.webp" media="(min-width: 50em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap">
      ...
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-015.md.webp" media="(min-width: 50em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap mb-2">
      <picture class="img half-left mb-2 hidden">
        <source srcset="/img/samples/get-konnected/gk-process-016.md.webp" media="(min-width: 63em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap mb-2">
      <picture class="img half-left mb-2 hidden">
        <source srcset="/img/samples/get-konnected/gk-process-017.md.webp" media="(min-width: 63em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap">
      <div class="column mb-2">
        <div class="grid-content">
          <picture class="img mb-2 hidden">
            <source srcset="/img/samples/get-konnected/gk-process-020.md.webp" media="(min-width: 50em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap mb-2">
      <picture class="img half-left mb-2 hidden">
        <source srcset="/img/samples/get-konnected/gk-process-021.md.webp" media="(min-width: 63em)" type="image/webp">
    ...
    <section class="main grid-in grid-gap mb-2">
      <picture class="img half-left mb-2 hidden">
        <source srcset="/img/samples/get-konnected/gk-process-023.md.webp" media="(min-width: 63em)" type="image/webp">
    ...
    <section class="main grid-in mb-4">
      <div class="half-right grid-content">
        <h3>Need a website that works wonders?</h3>
