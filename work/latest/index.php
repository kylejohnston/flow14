...
<head>
	...
	<title>Latest Work | flow14. A Design Studio.</title>
...
<body>
    ...
    <section class="main grid-in mb-4">
      <div class="testimonial">
				<div class="source pl-1 pr-1 order-2">
					<p><strong>Mayor Marty Walsh</strong><br>City of Boston</p>
				</div>
				<div class="quote pl-1 pr-1 order-1">
					<p>“Get Konnected’s new digital marketplace is an incredible tool that will increase the visibility of local black and brown businesses, allowing our businesses to be more accessible to the public.”</p>
        </div>
      </div>
    </section>
    ...
    <!-- <section class="main grid-in mb-4">
      <div class="full mb-2">
        <img class="" src="/img/samples/latest/happy-valley-flyers.lg.jpg" alt="">
      </div>
      <div class="half-right grid-content mb-3">
    ...
    <!-- <div class="full grid-in mb-4">
      <img src="/img/samples/latest/happy-valley-flyers.lg.jpg" alt="">
    </div> -->


    <section class="main grid-in mb-4">
      <div class="half-right grid-content">
        <h3>Ready for design that works wonders for your company?</h3>
