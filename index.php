...
<body class="neutral welcome-home homepage">
	...
	<section class="custom-grid spacer-6--bottom">
		<div class="thumbnail"
		style="grid-column: 7 / 11; grid-row: 1 / 3; height:auto; z-index:3">
			<picture>
				<source media="(min-width: 1012px)" srcset="img/samples/hnc-living/hnc-living-logo-desktop.svg">
