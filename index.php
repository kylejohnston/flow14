...
<body>
	<header class="r-fixed">
			<div class="text-xl uppercase hamburger color-orange" style="position:absolute;z-index:201;">
				<svg style="width:24px;height:24px;"fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8h16M4 16h16"></path></svg>
			</div>
	</header>

	<div class="grid">
		<div class="px-2 home-intro bg-gradient shift-right">
			<div class="my-3 shift-right-content" style="grid-column: 2 / 6;">
				<div class="mb-1 logo fill-black"><?php include($_SERVER['DOCUMENT_ROOT'] . '/includes/flow14.php'); ?></div>
				<h1 class="mb-2 text-xxl color-white" style="">Design That Makes a Difference</h1>
				<h2 class="mr-3 normal-case color-white" style="margin-bottom:0">We stay busy by designing things that drive results for your business.</h2>
			</div>
		</div>
		<div class="color-block"></div>
	</div>

	<h2 class="my-3 text-center brand-title">How We Do It</h2>
	...
	<div class="grid">
		<section class="mb-4 main grid-in">
	...
	<h2 class="hidden mb-3 text-center brand-title" style="">What We&rsquo;ve Made</h2>
    ...
    <section class="mb-4 main grid-in">
      <div class="testimonial">
				<div class="order-2 pl-1 pr-1 source">
	...
	<div class="grid">
		<section class="mb-4 main grid-in">
			<div class="half-right grid-content">
				...
				<a class="my-1 cta" href="/contact/" style=""><h3 class="m-none">Let&rsquo;s Talk<span style="letter-spacing:-3px;">――――</span></h3></a>
			</div>
		</section>
	</div>
